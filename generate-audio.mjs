...
// Per-word model overrides: multilingual_v2 mispronounces a handful of words
// (dune -> DooNeh, mule, kite, shell, and "sea" which it reads as Spanish),
// so use the English-tuned turbo model for those.
const TURBO = "eleven_turbo_v2_5";
const MODEL_OVERRIDES = { dune: TURBO, mule: TURBO, kite: TURBO, shell: TURBO, sea: TURBO };
